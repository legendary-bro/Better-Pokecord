...
## 5.0 Message Spam
I must stress that you should first test, and then use this in a private server. I accept no responsibility for whatever situation you may find yourself in because you used this in a public server. The Rocket server is always open to people wanting to test this or any other commands out, I only ask that you stay in the spam channels when doing so. Again, do your testing and spamming privately.
